...
export function TemplatesMetrics({ templates }: TemplatesMetricsProps) {
  ...
  return (
    <div className="w-full rounded-2xl border border-border bg-card/60 backdrop-blur-xl p-5 shadow-[0_8px_30px_rgb(0,0,0,0.4)] flex flex-wrap items-center gap-x-10 gap-y-4 relative overflow-hidden group transition-colors">
      {/* Background Glow */}
      ...
      <div className="flex items-center gap-3 relative z-10">
        <div className="flex flex-col">
          ...
          <span className="text-xl font-black text-emerald-400 leading-tight">{approved.toLocaleString()}</span>
        </div>
      </div>
      ...
      <div className="flex items-center gap-3 relative z-10">
        <div className="flex flex-col">
          ...
          <span className="text-xl font-black text-purple-400 leading-tight">{marketing.toLocaleString()}</span>
        </div>
      </div>
      ...
      <div className="flex items-center gap-3 relative z-10">
        <div className="flex flex-col">
          ...
          <span className="text-xl font-black text-amber-400 leading-tight">{utility.toLocaleString()}</span>
        </div>
      </div>
