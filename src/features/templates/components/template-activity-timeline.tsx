...
export function TemplateActivityTimeline() {
  return (
    <div className="w-full flex flex-col h-full space-y-5">
      ...
      <div className="flex-grow flex flex-col items-center justify-center rounded-2xl border border-border bg-secondary/40 p-8 min-h-[300px] transition-colors text-center relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center max-w-sm">
          <div className="h-16 w-16 rounded-[1.2rem] bg-secondary flex items-center justify-center border border-border shadow-[0_10px_20px_rgba(0,0,0,0.3)] mb-4">
